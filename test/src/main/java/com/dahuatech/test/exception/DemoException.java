package com.dahuatech.test.exception;

import com.dahuatech.test.demo.Demo;
import lombok.Data;
...
public class DemoException extends RuntimeException {
     ...
     *    System.out.println(e.getCause()); // 一般是null 因为一般自定义或者系统异常类如ArithmeticException都不会个cause赋值
     *
     * 2、注意: 一般情况下不会直接在标准输出打印出来 都是打到日志里
     *
     * 3、日志打印规范
     *  3.1 一般来说如果条件不满足打 logger.info("xxxxxxxxxxxxxxxxxxx")提示信息
     *  3.2 如果是抛出异常则打 logger.info("不满足的原因", exceptionObj)
     */
